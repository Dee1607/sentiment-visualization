...
def main():
    ...
    while start_date <= end_date:
        ...
        temp.append(random.choice([0,random.randrange(-100, 100)]))
        temp.append(random.choice(country_list))
        data.append(temp)

    with open("UkraineTimeSeries.csv", "w", encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
